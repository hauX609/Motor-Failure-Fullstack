...
class Validator:
    ...
    def normalize_severity(severity: str) -> str:
        """Normalize an alert severity to the canonical DB label."""
    ...
    def validate_severity(severity: str) -> bool:
        ...
        return Validator.normalize_severity(severity) in {'Warning', 'Degrading', 'Critical'}
    ...
    def get_alert_severity_for_status(status: str) -> str:
        ...
        return status_to_severity_map.get(normalized, 'Warning')
