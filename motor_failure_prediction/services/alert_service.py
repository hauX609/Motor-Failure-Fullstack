...
class AlertService:
    ...
    def create_alert(motor_id: str, severity: str, message: str) -> bool:
        ...
        try:
            ...
            db_severity = Validator.normalize_severity(
                Validator.get_alert_severity_for_status(severity)
            )
            if not db_severity:
    ...
    def batch_create_alerts(alerts_data: List[Dict]) -> int:
        ...
        try:
            ...
            for alert in alerts_data:
                ...
                db_severity = Validator.normalize_severity(
                    Validator.get_alert_severity_for_status(alert['severity'])
                )
                if not db_severity:
    ...
    def get_alerts(motor_id: str = None, severity: str = None,
        ...
        try:
            ...
            if severity:
                normalized_severity = Validator.normalize_severity(severity)
